...
import com.felix.NodeFactoryRandom_old;
...
public class RandomTiledGeneratorApp extends ApplicationAdapter    {
    private static final String TAG = RandomTiledGeneratorApp.class.getName();
    Texture img;
   // TiledMap tiledMap;
...
//    String labelText = "Debug Log:\nNew Line:";
    ...
    public void create () {
       ...
       //  tiledMap = new TmxMapLoader().load("data/little_level.tmx");
        ...
        //TODO remove the 10,10 add the
        navGraph = NodeFactoryRandom_old.createGraph(20,20);
        navGraph.setDebug(debug);

        //TODO remvoe the 200, 200
